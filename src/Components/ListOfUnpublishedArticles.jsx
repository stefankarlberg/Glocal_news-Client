...
import { Header, Container, Grid, Image, Card} from 'semantic-ui-react';
      ...
      <div>
        {this.state.articles.map(article => {
          if (article.published === false) {
            return (
                  <Card style={{ color: 'black' }} fluid key={article.id} as={Link} to={{ pathname: `/full-article/${article.id}`, state: { success_message: false, review_form: true } }} >
                    <Grid id={article.id} >
                      <Grid.Column width={5} >
